...
class Net(nn.Module):
    ...
    def forward(self, content, style, batch_size):
        ...
        return output1, rc1, rs1, output2, rc2, rs2, l_identity1, l_identity2, content_contrastive_loss, style_contrastive_loss, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss
